...
export class TweetResolverBase {
  ...
  async getComment(@graphql.Parent() parent: Tweet): Promise<Comment | null> {
  ...
  async getLike(@graphql.Parent() parent: Tweet): Promise<Like | null> {
    const result = await this.service.getLike(parent.id);
